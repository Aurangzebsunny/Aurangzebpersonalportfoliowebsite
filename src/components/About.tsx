...
export function About() {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 md:py-32 bg-muted/30 relative overflow-hidden">
          ...
          {profileImage && (
            <div className="flex justify-center mb-6 sm:mb-8">
              <motion.div
                ...
                className="relative"
              >
                <div className="w-40 h-40 sm:w-52 sm:h-52 rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl hover-glow relative">
                  <img 
                    src={profileImage} 
                    alt="Aurangzeb Sunny" 
