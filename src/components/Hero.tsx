...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20 px-4"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-64 sm:w-[500px] h-64 sm:h-[500px] rounded-full blur-3xl"
          style={{
        ...
        />
        <motion.div
          className="absolute top-1/2 right-1/3 w-32 sm:w-64 h-32 sm:h-64 rounded-full blur-2xl"
          style={{
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6 sm:mb-8 text-foreground leading-tight px-2">
            Design With Purpose,
            <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground hover-glow uppercase tracking-wider px-6 sm:px-8 py-6 text-sm sm:text-base border-2 border-primary hover:scale-105 transition-all duration-300 shadow-lg"
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto glass-effect hover-glow uppercase tracking-wider px-6 sm:px-8 py-6 text-sm sm:text-base border-2 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300"
              asChild
            >
      ...
      <Dialog open={appointmentOpen} onOpenChange={setAppointmentOpen}>
        <DialogContent className="max-w-md mx-4">
          <DialogHeader>
            <DialogTitle className="text-xl sm:text-2xl gradient-text">Book a Free Consultation</DialogTitle>
